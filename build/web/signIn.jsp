<%-- 
    Document   : signIn
    Created on : Jan 23, 2021, 2:26:41 PM
                            ...
                            <form action="SignInController" method="POST">
                                <fieldset style="">
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Enter email" value="${sessionScope.EMAIL}" name="txtEmail" type="text" style="margin-bottom: 28px; height: 42px; font-family: 'Patua One', cursive">
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-top: -12px">
                                        <input class="form-control" placeholder="Enter password" value="${sessionScope.PASS}" name="txtPassword" type="password" value="" style="margin-bottom: 37px; height: 42px; font-family: 'Patua One', cursive">
                                    </div> 
